...
void USART3_IRQHandler(void) {
  ...
  /*if (LL_USART_IsActiveFlag_RXNE(USART3)) {
    RingBuffer_Queue(&ring_buffer, LL_USART_ReceiveData8(USART3));
  ...
  //= Frame error, Overrun error, Noise error check
